...
<body>
    ...
    <div class="fixed-video-bg">
        <video id="bgVideo" autoplay muted loop playsinline preload="auto" poster="<?php echo e(asset('assets/images/logo.png')); ?>">
            <source src="<?php echo e(asset('uploads/products/bg.mp4')); ?>" type="video/mp4">
        </video>
    </div>
        ...
        <div class="container">
            ...
            <div class="grid-catalog" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 25px;">
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $firstImg = !empty($product['images']) ? $product['images'][0] : 'placeholder.jpg'; ?>
                    <div class="product-card glass-card" style="overflow:hidden;">
                        <div class="product-img" style="height: 200px; position: relative; overflow: hidden;">
                            ...
                            <?php endif; ?>
                            <img src="<?php echo e(asset('uploads/products/' . $firstImg)); ?>" alt="<?php echo e($product['name']); ?>" loading="lazy" style="width:100%; height:100%; object-fit:cover; transition:0.5s;">
                            <span style="position:absolute; top:10px; right:10px; background:rgba(0,0,0,0.8); color:var(--gold); padding:4px 12px; border-radius:20px; font-weight:700; font-size:0.8rem; z-index:2;"><?php echo e($product['price']); ?></span>
                        </div>
                        <div class="product-body" style="padding: 20px;">
                            <h3 style="margin-bottom:8px; font-size:1.1rem;"><?php echo e($product['name']); ?></h3>
                            <p style="color:#aaa; font-size:0.85rem; margin-bottom:15px; line-height:1.5;"><?php echo e(Str::limit($product['description'], 70)); ?></p>
                            <div style="display:flex; gap:8px;">
                                <button onclick='openModal(<?php echo json_encode($product, 15, 512) ?>)' style="flex:1; padding:10px; background:rgba(255,255,255,0.05); border:1px solid rgba(255,255,255,0.1); color:white; border-radius:8px; cursor:pointer; font-size:0.8rem;"><i class="fas fa-images"></i> Detail</button>
                                <a href="https://wa.me/6281324481252?text=Booking <?php echo e(urlencode($product['name'])); ?>" target="_blank" style="background:#25D366; color:white; padding:10px 15px; border-radius:8px; text-decoration:none; display:flex; align-items:center; gap:5px; font-size:0.8rem;"><i class="fab fa-whatsapp"></i> Booking</a>
                            </div>
                        </div>
                    </div>
        ...
        function openModal(product) {
            ...
            if(product.images && product.images.length > 0) {
                product.images.forEach(img => {
                    slider.innerHTML += `<img src="<?php echo e(asset('uploads/products/')); ?>/${img}" style="min-width:100%; height:100%; object-fit:cover;">`;
                });
            } else {
                slider.innerHTML = `<img src="<?php echo e(asset('assets/images/placeholder.jpg')); ?>" style="min-width:100%; height:100%; object-fit:cover;">`;
            }
...
</html><?php /**PATH C:\laragon\www\sangkuriang-rent\resources\views/welcome.blade.php ENDPATH**/ ?>